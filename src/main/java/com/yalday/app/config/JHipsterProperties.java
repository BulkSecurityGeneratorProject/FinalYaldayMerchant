...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "FinalYaldayMerchant@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "FinalYaldayMerchant API";

        private String description = "FinalYaldayMerchant API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "FinalYaldayMerchant";
